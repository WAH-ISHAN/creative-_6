    ...
    >
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7">
          <h2
            ref={headlineRef}
            className="font-editorial font-bold text-xl md:text-3xl md:text-5xl sm:text-7xl md:text-8xl lg:text-[6.5rem] leading-[0.9] tracking-tight uppercase text-white"
          >
            YOUR STORY.<br />
            PRESERVED<br />
        ...
        <div className="lg:col-span-5 flex flex-col items-start justify-center pl-0 lg:pl-6 space-y-8">
          ...
          <button
            ...
            data-cursor="cta"
            className="group inline-flex items-center gap-4 px-4 md:px-8 py-4 bg-[var(--fx-yellow)] text-black hover:bg-white text-xs sm:text-sm font-mono-tech uppercase tracking-[0.25em] font-bold transition-all cursor-pointer rounded-sm shadow-2xl hover:scale-105"
          >
