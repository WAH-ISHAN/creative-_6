              ...
              <div className="p-6 sm:p-8 bg-[#0a0a0a] border border-white/15 rounded-sm space-y-6 shadow-2xl">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
                  <div className="flex items-center gap-3.5">
                    <div className="w-10 h-10 rounded-full bg-[#1877F2]/20 border border-[#1877F2]/40 flex items-center justify-center text-[#1877F2] flex-shrink-0">
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-editorial uppercase text-white tracking-wide">
                        Official Facebook Reels & Shoots
                      </h3>
                      <p className="text-xs font-mono-tech text-gray-400 mt-0.5">
                        Watch verified 4K cinema reels and view full high-res photo albums directly on CreativeFX
                      </p>
                    </div>
                  </div>
                  ...
                  {project.socialUrl && (
                    ...
                    >
                      <span>{project.socialLabel || 'VIEW ALL ON FACEBOOK'}</span>
                      <ArrowUpRight className="w-3.5 h-3.5" />
                    </a>
                  )}
                </div>
                ...
                {hasBoth ? (
                    ...
                    {reels.length > 0 && (
                      <div className="space-y-3">
                        <div className="flex items-center gap-2 text-xs font-mono-tech tracking-widest text-[var(--fx-yellow)] uppercase">
                          ...
                          <span>4K CINEMA VIDEO REELS ({reels.length})</span>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                          {reels.map((post, pIdx) => (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="group/post flex items-center justify-between p-3.5 bg-white/5 hover:bg-[#1877F2]/15 border border-white/10 hover:border-[#1877F2]/60 rounded-sm transition-all duration-200 cursor-pointer"
                            >
                              <div className="flex items-center gap-3 min-w-0">
                                <div className="w-8 h-8 rounded-sm bg-black/80 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover/post:border-[#1877F2]/60">
                                  <Film className="w-4 h-4 text-[var(--fx-yellow)] group-hover/post:text-[#4ea0ff]" />
                                </div>
                                <div className="min-w-0">
                                  <p className="text-xs font-medium text-white group-hover/post:text-[#4ea0ff] transition-colors truncate">
                                    {post.name}
                                  </p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                          {photos.map((post, pIdx) => (
                            ...
                            >
                              <div className="flex items-center gap-3 min-w-0">
                                <div className="w-8 h-8 rounded-sm bg-black/80 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover/post:border-[#1877F2]/60">
                                  <Camera className="w-4 h-4 text-gray-400 group-hover/post:text-[#4ea0ff]" />
                                </div>
                                <div className="min-w-0">
                                  <p className="text-xs font-medium text-white group-hover/post:text-[#4ea0ff] transition-colors truncate">
                                    {post.name}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                    {project.socialPosts.map((post, pIdx) => (
                      <a
                        key={pIdx}
                        href={post.url}
                        target="_blank"
                      ...
                      >
                        <div className="flex items-center gap-3 min-w-0">
                          <div className="w-8 h-8 rounded-sm bg-black/80 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover/post:border-[#1877F2]/60">
                            {post.type === 'post' || post.type === 'album' ? (
                              <Camera className="w-4 h-4 text-gray-400 group-hover/post:text-[#4ea0ff]" />
                            ) : (
                              <Film className="w-4 h-4 text-[var(--fx-yellow)] group-hover/post:text-[#4ea0ff]" />
                            )}
                          ...
                          <div className="min-w-0">
                            ...
                            <span className="text-[10px] font-mono-tech text-gray-500 uppercase tracking-wider block">
                              {post.type === 'post' || post.type === 'album' ? 'PHOTO ALBUM ↗' : 'CINEMA REEL ↗'}
                            </span>
                          </div>
                        </div>
                        <ArrowUpRight className="w-4 h-4 text-gray-500 group-hover/post:text-white group-hover/post:translate-x-0.5 group-hover/post:-translate-y-0.5 transition-transform flex-shrink-0 ml-2" />
